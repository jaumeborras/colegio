        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.2fr_0.8fr_0.8fr_1fr] gap-8 items-start">
          ...
          <div className="md:pt-[38px]">
            ...
            <div className="flex flex-wrap gap-4 items-center">
              ...
              <a href="http://www.sanca.tv" target="_blank" rel="noopener noreferrer" className="text-white hover:opacity-60 transition-opacity text-sm font-bold tracking-wide">Sanca TV</a>
            </div>
          </div>
