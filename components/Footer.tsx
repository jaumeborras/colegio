  ...
  return (
    <footer ref={footerRef} className="relative overflow-hidden" style={{ backgroundColor: "#001440" }}>
      ...
      <div className="relative max-w-screen-xl mx-auto px-6 py-14 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-[1.2fr_0.8fr_0.8fr_1fr] gap-8 items-start">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              <a href="tel:971220575" className="inline-flex items-center gap-2 text-base font-bold text-white hover:text-white/75 transition-colors">
              ...
              <a href="mailto:csc@colegiosancayetano.com" className="inline-flex items-center gap-2 text-base font-bold text-white hover:text-white/75 transition-colors">
                <svg className="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
          ...
          <div className="md:pt-[38px]">
            <p className="text-xs font-semibold text-white/50 uppercase tracking-widest mb-4">{t("footer.follow", lang)}</p>
            <div className="flex flex-wrap gap-4 items-center">
              ...
              <a href="http://www.sanca.tv" target="_blank" rel="noopener noreferrer" aria-label="Sanca TV">
                <img
                  ...
                  alt="Sanca TV"
                  style={{ height: 28, width: "auto", display: "block", transition: "opacity 0.2s ease", marginTop: -8}}
